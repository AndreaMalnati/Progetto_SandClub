 ...
 * Use the {@link CapsFragment#newInstance} factory method to
...
public class CapsFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        // Stampare un messaggio quando il fragment viene aperto
        Toast.makeText(getActivity(), "Caps", Toast.LENGTH_SHORT).show();
    }
}