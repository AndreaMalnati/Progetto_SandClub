...
public interface BeerCallback {
    ...
    void onBeerFavoriteStatusChanged(List<Beer> beer, String idToken); //Aggiornamento di tutte la lista birre
    ...
    void onSuccessFromCloudWriting(Beer beer, String idToken);
